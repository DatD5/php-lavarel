...
@endif
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="{{$theloai->tentheloai}}" name="tentheloai" id="slug" onkeyup="ChangeToSlug();" aria-describedby="emailHelp" placeholder="tên dannh mục ....">
  </div>
